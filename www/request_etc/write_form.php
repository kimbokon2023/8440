...
@media (max-width: 768px) {
	...
	/* col-sm-8, col-sm-4, col-sm-7, col-sm-5, col-sm-9, col-sm-3, col-sm-12 모바일에서 전체 너비 */
	.col-sm-8, .col-sm-4, .col-sm-7, .col-sm-5, .col-sm-9, .col-sm-3, .col-sm-12 {
		width: 100% !important;
