                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr onclick="redirectToView('<?php echo htmlspecialchars($item_num); ?>', '<?php echo htmlspecialchars($tablename); ?>')">
                                        <td class="text-center"><?php echo $start_num; ?></td>
                                        <td class="text-center"><?php echo htmlspecialchars($division); ?></td>
                                        <td><?php echo $item_subject; ?></td>
                                        <td class="text-center"><?php echo htmlspecialchars($item_nick); ?></td>
                                        <td class="text-center"><?php echo htmlspecialchars($item_date); ?></td>
                                    </tr>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#writeBtn").click(function() {
                ...
                customPopup(url, 'AI prompt', 1300, 850);
            });
