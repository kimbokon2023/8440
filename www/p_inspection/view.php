                    ...
                    <tbody>
                        <tr>
                            ...
                            <td rowspan="2" class="text-center align-middle" data-label="작업">
                                <div class="d-flex flex-column">
                                    <button type="button" id="closeBtn" class="btn btn-dark btn-sm mb-1">&times; 닫기</button>
                                    <button type="button" id="saveBtn" class="btn btn-dark btn-sm mb-1"><i class="bi bi-floppy-fill"></i> 저장</button>
                        ...
                        <tr>
                            ...
                            <td colspan="5" class="text-center align-middle" data-label="현장명 입력">
                                <input id="subject" class="form-control" name="subject" type="text" onkeypress="enterCheck(event);" size="50" value="<?= htmlspecialchars($subject, ENT_QUOTES) ?>">
                            </td>
                        </tr>
                    </tbody>
                </table>
