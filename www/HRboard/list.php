        ...
        <div class="card justify-content-center">
            <div class="card-body">
                ...
                <div class="d-flex mb-2 px-5 px-lg-2 mt-2 justify-content-center align-items-center">
                    <span class="total-count">▷ 전체: <?php echo htmlspecialchars($total_row, ENT_QUOTES, 'UTF-8'); ?>건</span>
                ...
                <div class="d-flex justify-content-center">
                    <table class="table table-hover" id="myTable">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr data-num="<?php echo htmlspecialchars($item_num, ENT_QUOTES, 'UTF-8'); ?>" data-tablename="<?php echo htmlspecialchars($tablename, ENT_QUOTES, 'UTF-8'); ?>" onclick="redirectToView('<?php echo htmlspecialchars($item_num, ENT_QUOTES, 'UTF-8'); ?>', '<?php echo htmlspecialchars($tablename, ENT_QUOTES, 'UTF-8'); ?>')">
                                <td class="text-center" data-label="번호"><?php echo htmlspecialchars($start_num, ENT_QUOTES, 'UTF-8'); ?></td>
                                <td class="text-center" data-label="구분"><?php echo htmlspecialchars($division, ENT_QUOTES, 'UTF-8'); ?></td>
                                <td data-label="글제목"><?php echo $item_subject; ?></td>
                                <td class="text-center" data-label="작성"><?php echo htmlspecialchars($item_nick, ENT_QUOTES, 'UTF-8'); ?></td>
                                <td class="text-center" data-label="등록일"><?php echo htmlspecialchars($item_date, ENT_QUOTES, 'UTF-8'); ?></td>
                            </tr>
                            <?php
                                $start_num--;
                            }
...
(function() {
    ...
    function renderMobileCards() {
        ...
        rows.each(function() {
            ...
            var tablename = $row.attr('data-tablename') || '<?php echo htmlspecialchars($tablename, ENT_QUOTES, 'UTF-8'); ?>';
            var tds = $row.find('td');
