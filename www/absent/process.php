...
try {
    ...
    error_log("al 조회 오류: " . $ex->getMessage());
}
                    ...
                    <form id="board_form" class="form-signin" method="post">
                        ...
                        <span class="form-control">
                            ...
                            for ($i = 0; $i < count($item_arr); $i++) {
                                if ($item == $item_arr[$i]) {
                                    echo "<input type='radio' name='item' checked='checked' value='" . $item_arr[$i] . "'> " . $item_arr[$i] . " &nbsp;";
                                } else {
                                    echo "<input type='radio' name='item' value='" . $item_arr[$i] . "'> " . $item_arr[$i] . " &nbsp;";
                                }
                            }
                            ?>
                        </span>
                        ...
                        <span class="form-control">
                            신청종료일 <input type="date" id="askdateto" name="askdateto" readonly required value="<?=$askdateto?>">
                        </span>
                        <span class="form-control">
                        ...
                        <select name="content" id="content" readonly class="form-control text-center">
                            ...
                            for ($i = 0; $i < count($content_arr); $i++) {
                                if ($content == $content_arr[$i]) {
                                    echo "<option selected readonly value='" . $content_arr[$i] . "'>" . $content_arr[$i] . "</option>";
                                } else {
                                    echo "<option readonly value='" . $content_arr[$i] . "'>" . $content_arr[$i] . "</option>";
                                }
                            }
                            ?>
                        </select>
                        ...
                        <button id="saveBtn" class="btn btn-lg btn-secondary btn-block" type="button">
                            <?php if ((int)$num > 0) echo '승인'; else echo '결재상신(등록)'; ?>
                        </button>
                        <?php if ((int)$num > 0) { ?>
