...
// document.getElementById('question').addEventListener('click', (e) => {
    ...
    // })
// })
// document.getElementById('orderNewBtn').addEventListener('click', (e) => {
 
     // Swal.fire({
        // title: '기존 주문서 불러오기',
        // input: 'text',
        // inputLabel: '업체명, 품목명 등 검색어',
...
// })
 ...
 // document.getElementById('orderNewBtn').addEventListener('click', async (e) => {
	...
	// let url = './orderlist.php?search=' + text ;
