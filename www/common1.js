function popupCenter(href, pop_name, w, h) {
    // 화면 가로 위치
    var xPos = (window.innerWidth / 2) - (w / 2) + window.screenX; // screenX 대신 screenLeft를 사용할 수도 있습니다.
    // 화면 세로 위치
    var yPos = (window.innerHeight / 2) - (h / 2) + window.screenY; // screenY 대신 screenTop을 사용할 수도 있습니다.
...
function customPopup(href, pop_name, w, h) {
    ...
    window.open(href, pop_name, features);
}
...
function EGI_click() {
	$("#steel_item").val("EGI").attr("selected", "selected") ;
}
function PO_click() {
	$("#steel_item").val("PO").attr("selected", "selected") ;
}
function CR_click() {
	$("#steel_item").val("CR").attr("selected", "selected") ;
}
function HL304_click() {
	$("#steel_item").val("304 HL").attr("selected", "selected") ;
}
function MR304_click() {
	$("#steel_item").val("304 MR").attr("selected", "selected") ;
}
function VB_click() {
	$("#steel_item").val("VB").attr("selected", "selected") ;
}
function MR201_click() {
	$("#steel_item").val("201 2B MR").attr("selected", "selected") ;
}
