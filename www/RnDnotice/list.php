 ...
 * RnDnotice 게시글 목록
 * 
 * 개발관련 Notice & 자료실 게시글 목록을 표시하고 검색 기능 제공
 */
...
<style>
    ...
    @media (max-width: 768px) {
        ...
        * {
        ...
        .d-flex.mb-2.px-5.px-lg-2.mt-2 .inputWrap {
            width: 100% !important;
            max-width: 100% !important;
        ...
        .d-flex.mb-2.px-5.px-lg-2.mt-2 .btnClear {
        ...
        .d-flex.mb-2.px-5.px-lg-2.mt-2 .btnClear::before {
            content: '×' !important;
        ...
        .d-flex.mb-2.px-5.px-lg-2.mt-2 .btnClear:hover::before {
...
$(document).ready(function() {
    ...
    dataTable.on('page.dt', function() {
        ...
        setCookie('RnDnoticepageNumber', RnDnoticepageNumber, 10); // 쿠키에 페이지 번호 저장
    });
