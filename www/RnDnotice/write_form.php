...
/**
 * RnDnotice 게시글 작성/수정 폼
 * 
 * 게시글 작성 및 수정, 파일 첨부 기능 제공
 */
            ...
            <div class="card-body">
                <div class="row">
                    <div class="d-flex justify-content-center align-items-center">
                        작성자 : &nbsp; <?= htmlspecialchars($user_nick, ENT_QUOTES, 'UTF-8') ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
                    <div class="d-flex mt-2 justify-content-center align-items-center">
                        <span class="form-control me-2" style="width: 50px;border:0px;">구분</span>
                        <input id="division" name="division" type="text" class="form-control me-2" style="width:200px;" autocomplete="off" value="<?= htmlspecialchars($division, ENT_QUOTES, 'UTF-8') ?>">&nbsp;
                        <span class="form-control me-2" style="width: 50px;border:0px;">제목</span>
                        <input id="subject" name="subject" type="text" required class="form-control" style="width:500px;" autocomplete="off" value="<?= htmlspecialchars($item_subject, ENT_QUOTES, 'UTF-8') ?>">&nbsp;
                    </div>
                </div>
            </div>
        </div>
