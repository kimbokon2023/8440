...
$totalsaleprice = 0;
 ...
 var_dump($value);
	...
	*/
            ...
            <div class="list-cell list-cell--50 ">	 <button type="button" id="recoverBtn"  onclick="recoveritem('<?=$num?>')" class="btn btn-outline-success" > 복구  </button>		</div>                                    
...
function recoveritem(num)
{   	
$('#ordernum').val(num);	
 $.ajax({
			url: "admindeleteshop.php?option=recovery",
    	  	type: "post",		
