   ...
   <?php
	...
	{     
     ...
     <div class="input-group p-1 mb-1">	 
         ...
         <span class="input-group-text align-text-center" style="width:350px;" >현  장  명</span>     
         ...
         <span class="input-group-text text-center" style="width:150px;">미래설치소장</span>               
		  ...
		  if ($page<=1)  
	       ...
	       while($row = $stmh->fetch(PDO::FETCH_ASSOC)) {
			 ...
			 <span class="input-group-text align-text-center" style="width:350px;" > <a href="#" onclick="javascript:intoval('<?=$workplacename?>','<?=$worker?>','<?=$numCeiling?>'); return false;" style="font-size=10px;" ><?= $workplacename ?>&nbsp;</a> </span>     
...
function intoval(name,worker,numCeiling)
	  {
			...
			document.getElementById("model").value = '천장';
