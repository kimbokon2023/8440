...
<div id="outlineprint">  
	...
	<div class="clear"> </div>
    <div id="row1">   <?=$user_name?> </div>    
	<div class="clear"> </div>
    <div id="row2">   <?=$send_company?> </div>
    <div class="clear"> </div>			
    <div id="row3">  <?=$workplacename?>  </div>   
    <div class="clear"> </div>		
    <div id="row4">   <?=$send_date?> </div>        
	<div class="clear"> </div>	
    <div id="row5">   <?=$send_deadline?>  이내 </div>           
	<div class="clear"> </div>	    
    <div id="row6">  </div>           
	<div class="clear"> </div>		
	...
	<?php
			...
			for($i=0 ; $i < 12 ; $i++) 	 // 5개의 데이터 기준으로 찍고 하단에 totalamount 기록하기 위함
			{ 
			  if($item_nameArr[$i]!=null) 
			  {				  
				   print '<div id="row7"> ';
						print '<div id="col1"> '.  $item_nameArr[$i]  . '</div>';			
						print '<div id="col2"> '.  $item_specArr[$i]  . ' &nbsp; </div>';			
						print '<div id="col3"> '.  $item_numArr[$i]  . ' &nbsp; </div>';			
						print '<div id="col4"> '.  $item_unitArr[$i] . ' &nbsp; </div>';	
						if( strlen($item_memoArr[$i])>25)
						    print '<div id="col5" style="font-size:13px;"> '.  $item_memoArr[$i] . ' &nbsp; </div>';	
						  else
							  print '<div id="col5"> '.  $item_memoArr[$i] . ' &nbsp; </div>';	
						print '<div id="col6"> '.  $item_noteArr[$i] . ' &nbsp; </div>';							
				   print '</div> ' ;
			  }
			  else
			    {
	  ...
	  ?>
		...
		<div class="clear"> </div>		  		
		  <?
		  for($i=0 ; $i < 7 ; $i++) 	 // 7개의 좌우 컬럼 찍어주기
			{ 			  
				   print '<div id="row9"> ';
						print '<div id="col1"> '.  $memoArr[$i]  . '</div>';			
						print '<div id="col2"> '.  $memoArr[$i + 7]  . '</div>';			
				   print '</div> ' ;			   
			}
			?>
		<div class="clear"> </div>		  				 		
