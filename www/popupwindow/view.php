...
<style>
    ...
    @media (max-width: 768px) {
        ...
        * {
        ...
        /* 제목 영역 최적화 */
        .d-flex.mt-3.mb-4.justify-content-center {
        ...
        /* 버튼 그룹 최적화 */
        .d-flex.p-1.m-1.mt-1.mb-1.justify-content-left.align-items-center {
            flex-direction: column !important;
            align-items: stretch !important;
            gap: 0.5rem !important;
            padding: 0.5rem !important;
        ...
        .d-flex.p-1.m-1.mt-1.mb-1.justify-content-left.align-items-center button {
            width: 100% !important;
        ...
        /* 제목/정보 영역 최적화 */
        .row.d-flex.p-2.m-2.mt-1.mb-1.justify-content-start.bg-secondary {
            flex-direction: column !important;
            align-items: stretch !important;
            padding: 0.75rem !important;
            margin: 0.5rem 0 !important;
        ...
        .row.d-flex.p-2.m-2.mt-1.mb-1.justify-content-start.bg-secondary .col-sm-7,
        .row.d-flex.p-2.m-2.mt-1.mb-1.justify-content-start.bg-secondary .col-sm-4 {
            width: 100% !important;
            max-width: 100% !important;
...
<div class="container">
    <div class="card mt-2 mb-4">
        <div class="card-body">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row d-flex p-2 m-2 mt-1 mb-1 justify-content-start bg-secondary text-white align-items-center">
                        <div class="col-sm-7 text-start fw-bold fs-6 me-3">화면표시/숨김 선택 : <?= $division ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 글제목 : <?= $item_subject ?></div>
                        <div class="col-sm-4 text-end"><?= $noticecheck_memo ?> |<?= $item_nick ?> | 조회 : <?= $item_hit ?> | <?= $item_date ?></div>
                    </div>
        ...
        if (Array.isArray(data) && data.length > 0) {
            data.forEach(function(fileData, i) {
                ...
                var fileStyle = window.innerWidth <= 768 
                    ? "width:100%; max-width:100%; word-wrap:break-word; overflow-wrap:break-word; text-align:center; padding:0.5rem;"
                    : "";
                
                $("#displayFile").append(
                    "<div class='row mb-3'>" +
                    "<div id='file" + i + "' class='col d-flex align-items-center justify-content-center' style='" + fileStyle + "'>" +
                    "<a href='#' onclick=\"popupCenter('" + link + "', 'filePopup', 800, 600); return false;\" style='word-wrap:break-word; overflow-wrap:break-word; max-width:100%;'>" +
                    realName +
                    "</a> &nbsp; &nbsp; " +
                    "</div>" +
                    "</div>"
