...
try {
    ...
    if (!isset($data['RefOrder'])) {
        throw new Exception('RefOrder is required');
    }
    ...
    echo json_encode(array(
        'status' => 'success', 
        'message' => 'Ref line saved successfully.',
        'savedName' => $savedName,
    ...
    // 오류 로깅 및 응답
    error_log("Error in saveRefLine.php: " . $ex->getMessage());
