...
/**
 * 전자결재 작성 폼 모달
 * eworks에서 모달 위에 띄우는 결재 상세내역 작성/수정 폼
 */

// 변수 초기화 (부모 파일에서 전달되지 않은 경우 대비)
$contents = $contents ?? '';
?>
        ...
        <div class="modal-content">
            <div class="modal-header" title="e결재 창">
                <h6 class="modal-title">
                    <i class="bi bi-credit-card-2-front-fill"></i> 결재
                </h6>
                <button type="button" class="btn btn-light-secondary" id="closeModaldetailBtn">
            ...
            <div class="modal-body">
                ...
                <div class="row">		
                    ...
                    <div id="approvalTable" class="col-sm-4"></div>
                </div>
                        ...
                        <div class="table-responsive mb-2">
                            <table class="table table-bordered">
                                <tbody>
                                    <tr class="align-items-center">
                                        ...
                                        <td>
                                            <select class="form-control" id="eworks_item" name="eworks_item" onchange="eworksItemChanged(this)">
                                                ...
                                                <option value="개발프로젝트 연구노트">개발프로젝트 연구노트</option>
                                            </select>
                                        </td>
                                        <td class="text-center">결재라인</td> 
                                        <td>								
                                            <div class="d-flex">			
                                                <input type="text" class="form-control" id="e_line" style="width:90%;" name="e_line">
                                                <input type="hidden" id="e_line_id" name="e_line_id">
                                                <button type="button" class="form-control" id="setLineBtn" onclick="setLine();" style="width:8%;">
                                    ...
                                    <tr class="align-items-center">
                                        <td class="text-center">결재진행</td>
                                        <td colspan="3">
                                            <input type="text" class="form-control" readonly id="e_prograss" name="e_prograss">
                                        </td>							  
                                        ...
                                        <td colspan="3">
                                            <div class="d-flex">			
                                                ...
                                                <button type="button" class="form-control" onclick="setRef();" style="width:8%;">
                                                    <i class="bi bi-search"></i>
                                                </button>	                                                  
                                            </div>							  
                                        </td>			
                                        ...
                                        <td colspan="7">
                                            <div class="row d-flex justify-content-center">
                                                <div id="htmlContainer">							  
                                                    <textarea id="contents" class="form-control" name="contents" rows="10"><?php echo htmlspecialchars($contents, ENT_QUOTES, 'UTF-8'); ?></textarea>	
                                                </div>
                                            </div>
                                        </td>		
                                    </tr>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-outline-dark btn-sm" id="closesecondModalBtn">
                    &times; 닫기
                </button>
            </div>
        </div>
