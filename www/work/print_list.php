...
// 출고예정일이 현재일보다 클때 조건
$common = " WHERE (DATE(endworkday) >= DATE(NOW())) ORDER BY endworkday";
...
<head>
    ...
    <script src="<?php echo $base_url; ?>/js/html2canvas.js"></script>  <!-- 스크린샷을 위한 자바스크립트 함수 불러오기 -->
...
<body>
    <div id="print_area">
        <div class="printlist_img">
            <div id="print_list">
                <div class="print1">출력일자 : <?php echo $nowday; ?></div>
                <div class="clear"></div>
...
try {
    ...
    while ($row = $stmh->fetch(PDO::FETCH_ASSOC)) {
        ...
        ?>
                ...
                <div class="print2"><?php echo $counter; ?></div>
                <div class="print3"><?php echo iconv_substr($endworkday, 5, 8, "utf-8"); ?></div>
                <div class="print4"><?php echo iconv_substr($workplacename, 0, 20, "utf-8"); ?></div>
                <div class="print5"><?php echo iconv_substr($worker, 0, 6, "utf-8"); ?></div>
                <div class="print6"><?php echo iconv_substr($sum_material, 0, 40, "utf-8"); ?></div>
                <div class="print7"><?php echo iconv_substr($workitem, 0, 20, "utf-8"); ?></div>
                <div class="clear"></div>
        <?php
        $counter++;
    }  // end of while
