...
<div class="container">			
	<div class ="d-flex align-items-center p-1justify-content-center" >
		<h1 class="h4 text-white">  시공소장 작업일정(생산예정일 기준 다음날) </h1>		
	</div>
 ...
 <span class="input-group-text bg-white"> 
	...
	<button type="button" class="button btn btn-secondary" onclick="week_calandar(1)"> > </button>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 시공소장 스케줄 확인 및 시공전, 시공후 사진 등록 기록
   <?print $radiopart; ?>   
	 </span>
   </div>
<div class ="d-flex align-items-center p-1 justify-content-center" > 
