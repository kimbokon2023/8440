...
<div class="d-flex p-2 mt-3 mb-1 justify-content-center">	
	<h3 id="clickableText">JAMB  월간 시공예정 스케줄 </h3> 
</div>
...
<script type="text/tmpl" id="tmpl">
  ...
  <table id="jamb_table"  class="calendar-table table table-condensed table-tight" style="table-layout:fixed; width: 100%;">
    <thead>
      <tr>
  ...
  <tbody> 
    ...
    <tr>
	  ...
	  {{ let isWeekend = (dayOfWeek === 6) || (dayOfWeek === 0); }}
       ...
       <td style="font-size:12px;" class="calendar-day {{: dayclass }} {{: isWeekend ? 'red-day':'' }} {{: thedate.toDateCssClass() }} {{: date.toDateCssClass() === thedate.toDateCssClass() ? 'selected':'' }} {{: daycss[i] }} js-cal-option" data-date="{{: thedate.toISOString() }}">
  ...
  function calendar($el, options) {
    ...
    $el.on('click', '.js-cal-prev', function () {
      ...
      // $t.popover({content: '<p><strong>' + time + '</strong></p>'+data.text, html: true, placement: 'auto left'}).popover('toggle');
	   ...
	   popupCenter('../work/view.php?navibar=1&num=' + data.id   , '잠 수주현황', 1500, 900);		   
