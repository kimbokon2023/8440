...
$(document).ready(function(){	  
	...
	function intoval(code, name)   // 클릭시 화면에 정보 보여줌, 코드명, 거래처
	{				
			...
			//   $("#CUST_DES", opener.document).val(name); 		
			  self.close();
	}
               ...
               console.log(data);			
				...
				$(opener.location).attr("href", "javascript:reloadlist();");	
                  self.close();					
					...
					if (window.opener && typeof window.opener.helloWorld === "function") {
						window.opener.helloWorld();
					}				  
