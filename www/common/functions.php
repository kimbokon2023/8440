 ...
 */
if (!function_exists('assetExists')) {
 ...
 */
if (!function_exists('assetWithFallback')) {
 ...
 */
if (!function_exists('getEnvironmentInfo')) {
...
if (!function_exists('NullCheckDate')) {
