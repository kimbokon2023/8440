...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<h1 class="display-2  text-left">
  <input type="button" class="btn btn-primary btn-lg " value="실측완료 전송버튼" onclick="javascript:input_measureday('process_DB.php?num=<?=$num?>')"> </h1>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<h1 class="display-2  text-left">
  <input type="button" class="btn btn-danger btn-lg " value="협의사항 기록&전달" onclick="javascript:input_message('voc.php?num=<?=$num?>')"> </h1>  
  </div>
<br>
<br>
...
<br>
	...
	<br>
<br>
  추가 메모(기타 사항) :<br> <textarea disabled rows="3" cols="30" name="memo" placeholder="추가적으로 기록할 내역" style="color:blue;" ><?=$memo?></textarea>
       <br>
