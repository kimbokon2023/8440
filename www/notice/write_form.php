				 ...
				 <div class="row"> 
					 <div class="col-3-sm"> 
						<div class="d-flex justify-content-center align-items-center"> 							 
							...
							<input type="checkbox" name="noticecheck" value="y" <?php if(!isset($noticecheck) || $noticecheck=='y') print 'checked'; ?> > &nbsp; 전체공지
						</div>
					</div>
					 <div class="col-5-sm"> 													
						<div class="d-flex  mt-2 justify-content-center align-items-center"> 							 
							제목 &nbsp; 					
							<input id="subject" name="subject" type="text" required class="form-control" autocomplete="off" style="width:500px;" <?php if($mode=="modify"){ ?> value="<?=$item_subject?>" <?php }?>>&nbsp;														
						</div>	
					</div>
				</div>
				</div>
