...
try{
				 $pdo->beginTransaction();
						 $sql = "insert into mirae8440.oem(orderday, firstord, secondord, workplacename, deadline, type1, inseung1, su, lc_su, etc_su, "; //10
						 $sql .= " car_insize1, memo, delivery, startday, workday, demand) "; //6  총16개
