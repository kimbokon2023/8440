...
$common = " where endworkday between date(now())+1 and date(now())+3 order by endworkday ";  // 출고예정일이 현재일보다 클때 조건
...
} elseif (isset($_POST["plan_output_check"])) {
    $plan_output_check = $_POST["plan_output_check"];
} else {
    $plan_output_check = '0';
}
...
} elseif (isset($_POST["output_check"])) {
    $output_check = $_POST["output_check"];
} else {
    $output_check = '0';
}
...
} elseif (isset($_POST["team_check"])) {
    $team_check = $_POST["team_check"];
} else {
    $team_check = '0';
}
...
} elseif (isset($_POST["measure_check"])) {
    $measure_check = $_POST["measure_check"];
} else {
    $measure_check = '0';
}		 
