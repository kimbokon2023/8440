...
<form name="board_form" id="board_form" method="post" action="batchDB.php?mode=search&year=<?php echo urlencode($year); ?>&search=<?php echo urlencode($search); ?>&process=<?php echo urlencode($process); ?>&asprocess=<?php echo urlencode($asprocess); ?>&fromdate=<?php echo urlencode($fromdate); ?>&todate=<?php echo urlencode($todate); ?>&up_fromdate=<?php echo urlencode($up_fromdate); ?>&up_todate=<?php echo urlencode($up_todate); ?>&separate_date=<?php echo urlencode($separate_date); ?>&view_table=<?php echo urlencode($view_table); ?>">
...
$(document).ready(function() {
    ...
    var arr3 = <?php echo json_encode($price_arr ?: array()); ?> || [];
    ...
    var su = <?php echo json_encode($su_sum_arr); ?>;
    var bon_su = <?php echo json_encode($bon_su_sum_arr); ?>;
    var lc_su = <?php echo json_encode($lc_su_sum_arr); ?>;
    var etc_su = <?php echo json_encode($etc_su_sum_arr); ?>;
