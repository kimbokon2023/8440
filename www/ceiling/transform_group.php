...
if (isset($_REQUEST["array"])) {
    $arrayString = $_REQUEST["array"];
    $numarr = explode(",", urldecode($arrayString));
}
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="d-flex mb-1">
                            <span class="input-group-text text-center checkrow text-primary" style="width:150px;">
                                <?=$i+1?> 주소 선택
                            </span>
                            <input type="text" name="text[]" id="text<?=$i?>" value="<?=$text_value?>" class="input-group-text text-left" style="text-align:left; width: 700px;">
                            <input type="text" name="textnum[]" value="<?=$textnum_value?>" size="2" class="text-center fs-6">
                            <input type="text" name="textset[]" value="<?=$textset_value?>" size="2" class="text-center fs-6">
                            <input type="text" name="textmemo[]" value="<?=$textmemo_value?>" size="10" class="text-center fs-6">
                        </div>
                    </div>
                    <?php } ?>
                </div>
