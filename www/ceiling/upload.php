            ...
            <div id="content">
                <div id="work_col2">
                    <div id="estimate_text2">
                        <!-- 공사진행현황 -->
                        <div class="sero1">
                            <img src="../img/work_title.png">
                        </div>
                        
                        <div id="write_button_renew">
                            <input type="image" src="../img/ok.png">&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="list.php?&page=<?=$page?>&search=<?=$search?>&find=<?=$find?>&process=<?=$process?>&yearcheckbox=<?=$yearcheckbox?>&year=<?=$year?>">
                        ...
                        <div class="sero2">
                            <input type="text" id="workplacename" name="workplacename" value="<?=$workplacename?>" size="50" placeholder="현장명" required>
                        </div>
                        <div class="clear"></div>
                        
                        <div class="sero1">현장주소 :</div>
                        <div class="sero2">
                            <input type="text" id="address" name="address" value="<?=$address?>" size="50" placeholder="현장주소">
                        </div>
                        <div class="clear"></div>
                        
                        <div class="sero1">원청 :</div>
                        <div class="sero2">
                            <input type="text" id="firstord" name="firstord" value="<?=$firstord?>" size="15" placeholder="원청">
                        </div>
                        <div class="sero1">담당 :</div>
                        <div class="sero2">
                            <input type="text" id="firstordman" name="firstordman" value="<?=$firstordman?>" size="10" placeholder="원청담당">
                        </div>
                        <div class="sero1">연락처 :</div>
                        <div class="sero2">
                            <input type="text" id="firstordmantel" name="firstordmantel" value="<?=$firstordmantel?>" size="14" placeholder="연락번호">
                        </div>
                        <div class="clear"></div>
                        
                        <div class="sero1">발주처 :</div>
                        <div class="sero2">
                            <input type="text" id="secondord" name="secondord" value="<?=$secondord?>" size="15" placeholder="발주처">
                        </div>
                        <div class="sero1">담당 :</div>
                        <div class="sero2">
                            <input type="text" id="secondordman" name="secondordman" value="<?=$secondordman?>" size="10" placeholder="발주처 담당자">
                        </div>
                        <div class="sero1">연락처 :</div>
                        <div class="sero2">
                            <input type="text" id="secondordmantel" name="secondordmantel" value="<?=$secondordmantel?>" size="14" placeholder="연락번호">
                        </div>
                        <div class="clear"></div>
                        
                        <div class="sero1">현장소장 :</div>
                        <div class="sero2">
                            <input type="text" id="chargedman" name="chargedman" value="<?=$chargedman?>" size="10" placeholder="현장담당자">
                        </div>
                        <div class="sero1">연락처 :</div>
                        <div class="sero2">
                            <input type="text" id="chargedmantel" name="chargedmantel" value="<?=$chargedmantel?>" size="10" placeholder="현장담당전화">
                        </div>
                        <div class="clear"></div>
                        <div class="space"></div>
                        <div class="clear"></div>
                        ...
                        <div class="sero2">
                            <input type="text" name="orderday" id="orderday" value="<?=$orderday?>" size="10" placeholder="발주접수일">
                        </div>
                        <div class="sero6" style="text-align:right; width:50px;">실측일 :</div>
                        <div class="sero2">
                            <input type="text" name="measureday" id="measureday" value="<?=$measureday?>" size="10" placeholder="실측일">
                        </div>
                        <div class="sero7" style="width:90px;">도면설계완료일 :</div>
                        <div class="sero2">
                            <input type="text" name="drawday" id="drawday" value="<?=$drawday?>" size="10" placeholder="도면설계일" oninput="this.value = this.value.replace(/[^0-9\-]/g,'')" onkeyup="date_mask(this.form.name, this.name)"/>
                        </div>
                        <div class="sero7" style="width:90px; color:red; font-weight:bold; text-align:right;">납기일 :</div>
                        <div class="sero2">
                            <input type="text" name="deadline" id="deadline" value="<?=$deadline?>" size="10" placeholder="납기일" oninput="this.value = this.value.replace(/[^0-9\-]/g,'')" onkeyup="date_mask(this.form.name, this.name)"/>
                        </div>
                        <div class="clear"></div>
                        
                        <div class="sero1">시공투입일:</div>
                        <div class="sero2">
                            <input type="text" name="workday" id="workday" value="<?=$workday?>" size="10" placeholder="투입일" oninput="this.value = this.value.replace(/[^0-9\-]/g,'')" onkeyup="date_mask(this.form.name, this.name)"/>
                        </div>
                        <div class="sero6">미래기업 시공팀 :</div>
                        <div class="sero2">
                            <input type="text" name="worker" id="worker" value="<?=$worker?>" size="10" placeholder="시공팀">
                        </div>
                        <div class="sero7">시공완료일 :</div>
                        <div class="sero2">
                            <input type="text" name="endworkday" id="endworkday" value="<?=$endworkday?>" size="10" placeholder="시공완료일" oninput="this.value = this.value.replace(/[^0-9\-]/g,'')" onkeyup="date_mask(this.form.name, this.name)"/>
                        </div>
                        <div class="clear"></div>
                        <div class="space"></div>
                        <div class="clear"></div> 	
                        ...
                        <div id="delivery_col" style="color:red;">운임(있을시 기록) :
                            <input type="text" name="delipay" value="<?=$delipay?>" placeholder="운임금액" onkeyup="inputNumberFormat(this)">
                            &nbsp;&nbsp;&nbsp; 청구방식 : &nbsp;&nbsp;&nbsp;
                        ...
                        <div class="sero9">
                            <input type="text" name="material1" id="material1" value="<?=$material1?>" size="15" placeholder="기타 재질">
                        </div>
                        <div class="sero8">
	...
	<?php			 
	     ...
	     switch ($material6) {
	        ...
	        <div class="clear"> </div> 				
                        ...
                        <div class="sero2">
                            <input type="text" name="widejamb" id="widejamb" value="<?=$widejamb?>" size="10" placeholder="와이드쟘 수량" oninput="this.value = this.value.replace(/[^0-9\-]/g,'')">
                        </div>
                        <div class="sero1">멍텅구리 :</div>
                        <div class="sero4">
                            <input type="text" name="normaljamb" id="normaljamb" value="<?=$normaljamb?>" size="10" placeholder="멍텅구리 수량" oninput="this.value = this.value.replace(/[^0-9\-]/g,'')">
                        </div>
                        <div class="sero1">쪽쟘 :</div>
                        <div class="sero4">
                            <input type="text" name="smalljamb" id="smalljamb" value="<?=$smalljamb?>" size="10" placeholder="쪽쟘 수량" oninput="this.value = this.value.replace(/[^0-9\-]/g,'')">
                        </div>
                        <div class="clear"></div>
                        
                        <div class="sero6">추가 내역 :</div>
                        <div class="sero5">
                            <textarea rows="5" cols="80" name="memo" id="memo" placeholder="추가적으로 기록할 내역"><?=$memo?></textarea>
                        </div>
                        <br><br><br><br>
                    </div>
                </div>
