...
<body>
    ...
    <div id="calwrap" style="float:left; width:100%; height:900px;">
        <div id="calwrap_col1" style="float:left; width:50px; height:900px; margin-left:10px;"></div>
    ...
    function drawGraph(item, weekend, arr) {
        if (item == 'all') {
            ...
            for (var i = 0; i < arr.length; i++) {
                if (i % 2 == 0) {
                    // 짝수 행 - 파란색
                    var text1 = new fabric.Text(arr[i], { 
                        left: 50, 
                        top: 10 + i * 30, 
                        fontSize: 16 
                    });
    ...
    function getToday() {
        ...
        var month = now.getMonth() + 1; // 1월이 0이므로 +1
