...
$item_sel = $_REQUEST["item_sel"] ?? '작년대비 월비교';
...
<form name="board_form" id="board_form" method="post" action="work_statistics.php?mode=search&year=<?php echo urlencode($year); ?>&search=<?php echo urlencode($search); ?>&process=<?php echo urlencode($process); ?>&asprocess=<?php echo urlencode($asprocess); ?>&fromdate=<?php echo urlencode($fromdate); ?>&todate=<?php echo urlencode($todate); ?>&up_fromdate=<?php echo urlencode($up_fromdate); ?>&up_todate=<?php echo urlencode($up_todate); ?>&separate_date=<?php echo urlencode($separate_date); ?>&view_table=<?php echo urlencode($view_table); ?>">
    <div class="container">
        <div class="modern-management-card mt-2 mb-2">
            <div class="card-header">
                <h3 style="margin: 0; font-size: 1.2rem;"><?php echo htmlspecialchars($title_message); ?></h3>
            </div>
            <div class="card-body">
                ...
                <div class="d-flex p-1 m-1 mt-1 mb-1 justify-content-center align-items-center">
                    ...
                    switch ($item_sel) {
                        ...
                        case $itemArr[2]:
                            ...
                            break;
                        case $itemArr[3]:
                            $item_sel_choice[3] = 'checked';
                            break;
                    }
                    ?>

                    <input id="item_sel" name="item_sel" type="hidden" value="<?php echo htmlspecialchars($item_sel); ?>">
                    <div class="input-group p-2 mb-2 justify-content-center align-items-center">
                        <span class="input-group-text justify-content-center align-items-center">
                            &nbsp; <?php echo htmlspecialchars($itemArr[0]); ?> <input type="radio" <?php echo $item_sel_choice[0]; ?> name="item_sel" value="<?php echo htmlspecialchars($itemArr[0]); ?>">
                            &nbsp; <?php echo htmlspecialchars($itemArr[1]); ?> <input type="radio" <?php echo $item_sel_choice[1]; ?> name="item_sel" value="<?php echo htmlspecialchars($itemArr[1]); ?>">
                            &nbsp; <?php echo htmlspecialchars($itemArr[2]); ?> <input type="radio" <?php echo $item_sel_choice[2]; ?> name="item_sel" value="<?php echo htmlspecialchars($itemArr[2]); ?>">
                            &nbsp; <?php echo htmlspecialchars($itemArr[3]); ?> <input type="radio" <?php echo $item_sel_choice[3]; ?> name="item_sel" value="<?php echo htmlspecialchars($itemArr[3]); ?>">
                        </span>
                        &nbsp; &nbsp;
                        <span class="input-group-text justify-content-center align-items-center">
                            <input id="view_table" name="view_table" type="hidden" value="<?php echo htmlspecialchars($view_table); ?>">
                            <input id="display_sel" name="display_sel" type="hidden" value="<?php echo htmlspecialchars($display_sel); ?>">
                            &nbsp; 도넛 <input type="radio" <?php echo $chartchoice[0]; ?> name="chart_sel" value="doughnut">
                            &nbsp; 바 <input type="radio" <?php echo $chartchoice[1]; ?> name="chart_sel" value="bar">
                            &nbsp; 라인 <input type="radio" <?php echo $chartchoice[2]; ?> name="chart_sel" value="line">
                            &nbsp; 레이더 <input type="radio" <?php echo $chartchoice[3]; ?> name="chart_sel" value="radar">
                            &nbsp; Polar Area <input type="radio" <?php echo $chartchoice[4]; ?> name="chart_sel" value="polarArea">
                        </span>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td class="text-center"><?php echo htmlspecialchars($type); ?></td>
