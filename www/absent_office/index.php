                    ...
                    <table class="table table-striped table-bordered" id="table_sum">
                        ...
                        <tbody>
                            ...
                            for ($i = 0; $i < $num_days + 3; $i++) {
                                ...
                                if ($i === 0) {
                                    echo '<td class="text-primary" data-label="구분"></td>';
                                    ...
                                    if ($thisday === '토' || $thisday === '일') {
                                        echo '<td class="text-danger" data-label="구분">' . ($i - 2) . '(' . $thisday . ')</td>';
                                    } else {
                                        echo '<td data-label="구분">' . ($i - 2) . '(' . $thisday . ')</td>';
                                    }
            ...
            <div class="d-flex mt-3 mb-3 justify-content-center align-items-center">
                ...
                try {
                    ...
                    <div class="d-flex flex-column flex-md-row align-items-center gap-2">
                        ...
                        <button type="button" class="btn btn-dark btn-sm" onclick="popupCenter('write_form_ask.php', '사무실 등록', 415, 520);return false;"><i class="bi bi-pencil"></i> 신규</button>
                        <input type="text" name="search" id="search" class="form-control" style="width:150px;" value="<?= htmlspecialchars($search, ENT_QUOTES, 'UTF-8') ?>" onkeydown="JavaScript:SearchEnter();" placeholder="검색어">
