                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr onclick="redirectToView('<?= htmlspecialchars($item_num, ENT_QUOTES, 'UTF-8') ?>', '<?= htmlspecialchars($tablename, ENT_QUOTES, 'UTF-8') ?>')" 
                                            ...
                                            data-subject="<?= htmlspecialchars(strip_tags($item_subject), ENT_QUOTES, 'UTF-8') ?>"
                                    ...
                                    error_log("AIprompt 조회 오류: " . $ex->getMessage());
                                }
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                dataTable.on('page.dt', function() {
                    ...
                    setCookie('RnDlistpageNumber', RnDlistpageNumber, 10);
                });
            ...
            function redirectToView(num, tablename) {
                ...
                customPopup(url, 'AI prompt', 1200, 900);
            }
