...
<style>
    ...
    @media (max-width: 768px) {
        ...
        * {
        ...
        /* 제목 영역 최적화 */
        .d-flex.mt-3.mb-1.justify-content-center span {
        ...
        .d-flex.mt-2.justify-content-center.align-items-center input#division,
    ...
    <form id="board_form" name="board_form" method="post" enctype="multipart/form-data">
        ...
        <div class="container">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="d-flex justify-content-center align-items-center">
                                작성자  : &nbsp;    <?= htmlspecialchars($nick, ENT_QUOTES, 'UTF-8') ?>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </div>
                            <div class="d-flex mt-2 justify-content-center align-items-center">
                                <span class="form-control me-2" style="width: 50px;border:0px;"> 구분 </span>
                                <input id="division" name="division" type="text" class="form-control me-2" style="width:200px;" autocomplete="off" <?php if ($mode == "modify") { ?> value="<?= htmlspecialchars($division, ENT_QUOTES, 'UTF-8') ?>" <?php } ?>>&nbsp;
                                <span class="form-control me-2" style="width: 50px;border:0px;"> 제목 </span>
                                <input id="subject" name="subject" type="text" required class="form-control" style="width:500px;" autocomplete="off" <?php if ($mode == "modify") { ?> value="<?= htmlspecialchars($item_subject, ENT_QUOTES, 'UTF-8') ?>" <?php } ?>>&nbsp;
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex mt-3 mb-1 justify-content-center">
                <textarea id="summernote" name="content" rows="20"><?= htmlspecialchars($content, ENT_QUOTES, 'UTF-8') ?></textarea>
            </div>
					...
					"<div class='row mb-3'>" +
						"<div class='col d-flex align-items-center justify-content-center'>" +
							"<a href='#' onclick=\"popupCenter('" + safeLink + "', 'imagePopup', 800, 600); return false;\">" +
								"<img id='image" + index + "' src='" + safeThumbnail + "' class='img-fluid' style='max-width:100%; height:auto;'>" +
							"</a> &nbsp;&nbsp;" +
...
function displayImageLoad() {
    ...
    if (Array.isArray(data) && data.length > 0) {
        data.forEach(function (fileData, i) {
			...
			$("#displayImage").append(
				"<div class='row mb-3'>" +
					"<div class='col d-flex align-items-center justify-content-center'>" +
						"<a href='#' onclick=\"popupCenter('" + safeLink + "', 'imagePopup', 800, 600); return false;\">" +
							"<img id='image" + i + "' src='" + safeThumbnail + "' class='img-fluid' style='max-width:100%; height:auto;'>" +
						"</a> &nbsp;&nbsp;" +
        ...
        $("#displayImage").append(
            "<div class='text-center text-muted'>No images </div>"
        );
    }
}
