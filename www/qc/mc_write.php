...
if ($num) {
    ...
    if ($row) {
        ...
        echo "<script>alert('해당 장비 정보가 없습니다.'); history.back();</script>";
        exit;
    }
}
?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form name="mc_form" method="post" action="mc_process.php">
                ...
                <div class="mb-3 row">
                    <label for="mcname" class="col-sm-2 col-form-label fw-bold">장비명 <span class="text-danger">*</span></label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="mcname" name="mcname" value="<?= htmlspecialchars($mcname) ?>" required placeholder="예: 유압식 절단기">
                    </div>
                </div>

                <div class="mb-3 row">
                    <label for="mcspec" class="col-sm-2 col-form-label fw-bold">규격</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="mcspec" name="mcspec" value="<?= htmlspecialchars($mcspec) ?>" placeholder="예: 3000MM">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="mcno" name="mcno" value="<?= htmlspecialchars($mcno) ?>" placeholder="시스템 내부 관리용 ID (예: laser01)">
                        <div class="form-text">QR코드 이미지 파일명과 연동될 수 있습니다.</div>
                    </div>
                </div>

                <div class="mb-3 row">
                    <label for="mcmaker" class="col-sm-2 col-form-label fw-bold">제조사</label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="mcmain" name="mcmain" value="<?= htmlspecialchars($mcmain) ?>" placeholder="예: 조성원">
                    </div>
                    <label for="mcsub" class="col-sm-2 col-form-label fw-bold">담당자(부)</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="mcsub" name="mcsub" value="<?= htmlspecialchars($mcsub) ?>" placeholder="예: 까심">
                    </div>
                </div>
