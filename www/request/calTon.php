...
<script src="https://8440.co.kr/order/order.js"></script>
<script src="https://8440.co.kr/common1.js"></script>
		...
		<div class="container ">	 
		    ...
		    <div class="card-header"> 			                        	                         		
						 <div class="input-group p-2 mb-1">							 
						  ...
						  종 류 : &nbsp; <input name="steel_item" id="steel_item" value='<?=$steel_item?>' >&nbsp; &nbsp; 
...
$(document).ready(function(){
	...
	$("#calBtn").click(function(){    // 계산하기 수량
	 ...
	 console.log(unit);
		...
		$("#steel_item", opener.document).val($('#steel_item').val() );
		$("#spec", opener.document).val($('#spec').val());
		$("#request_comment", opener.document).val($('#expected').val() + '톤 주문해 주세요');
		window.close();	 
