...
<div id="approvalModal" style="display:none;">
    ...
    <div class="card-body">
		<table class="table table-bordered">
			...
			<div class="row ">	  
				<div class="col-sm-7">	 
					...
					<button  type="button" class="btn btn-outline-primary btn-sm" id="newBtn" ><i class="bi bi-pencil"></i> </button>&nbsp;							
				...
				<div class="col-sm-5" >	 
					<div class="d-flex align-items-center p-2 text-left">			
						...
						<button  type="button" class="btn btn-dark btn-sm" id="SavesettingsBtn" >  <i class="bi bi-search"></i> </button>&nbsp;		
					</div>
				</div>
		...
		<button  type="button" class="btn btn-primary btn-sm"  id="openModalButton"> <i class="bi bi-tools"></i> 관리 </button> &nbsp;
