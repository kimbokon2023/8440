...
<br> 
  ...
  <input type="button" class="btn btn-primary btn-lg " value="초기목록" onclick="location.href='./index.php?num=<?=$num?>;'"> </h1> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input type="button" class="btn btn-secondary btn-lg " value="이전화면으로 돌아가기" onclick="location.href='./view.php?num=<?=$num?>;'"> </h1> 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  </div>
<br>
<br>
<form id="board_form" name="board_form" method="post" action="pic_insert.php"   enctype="multipart/form-data">  
	 ...
	 <H1  class="display-4 font-center text-center" > 시공전후 사진 등록/수정 </H1> 
 </div>
			<br>
			<div class="row">
...
<br>
  ...
  <input name="mainBefore" class="input" type="file" onchange="this.value" id="mainBefore"  required />
	   ...
	   <div class="row"> <div class="col">&nbsp;  <H1  class="display-5 font-center text-center" > </H1> </div></div>
