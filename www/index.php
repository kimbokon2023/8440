    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    <!-- ***** Logo Start ***** -->
                    <a href="index.php" class="logo me-1">
                        <h1 class="me-1" style="width:110%;">미래기업</h1>
                    </a>
                    <!-- ***** Logo End ***** -->
					...
					<li class="scroll-to-section">
						<button type="button" class="btn btn-outline-secondary btn-sm mx-1" onclick="popupCenter('https://blog.naver.com/mirae8440', 'NaverBlog', 1800, 900); return false;" style="padding: 0;" title="미래기업 네이버 블로그">
						...
						<button type="button" class="btn btn-outline-danger btn-sm mx-1" onclick="popupCenter('https://youtube.com/@miraecorp', 'YouTube', 1920, 1080); return false;" style="padding: 0;" title="미래기업 유튜브">
      ...
      <div class="col-lg-7">
        <div class="owl-carousel owl-testimonials">
          ...
          <div class="item">
            ...
            <div class="author">
              <img src="assets/images/miraeHistory6.png" style="width:auto;" alt="">
              <span class="category"> 
          ...
          <div class="item">
            ...
            <div class="author">
              <img src="assets/images/miraeHistory7.png" style="width:auto;" alt="">
              <span class="category"> 
					현위치  공장이전  
				</span>
            </div>
