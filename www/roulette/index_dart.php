...
<div class="container-fluid">  
 ...
 &nbsp;&nbsp;
    <span class="badge bg-dark text-white fs-4 "> &nbsp; 다트 순위 추첨 1인당 3회 기회, (20점 이상시 선물당첨) &nbsp;</span>
	<button type="button" class="btn btn-primary btn-sm ms-5" onclick='location.href="index.php"' > 	<i class="bi bi-radar"></i> 선물추첨 </button>&nbsp; &nbsp; 
  </div>	
  ...
  <div class="d-flex justify-content-center align-self-center mt-2">
    <div class="card col-sm-5" >
      <div class="card-body">
        ...
        <br>
		  <div class="d-flex justify-content-center align-items-center">
			 <input type="checkbox" id="both"  name="both" checked value="1"> 추첨 동시실행  &nbsp; &nbsp; &nbsp; &nbsp; 			 			 
			 <button type="button" class="btn btn-dark btn-sm " id='spin_person'> 순위 추첨 </button> 
		  </div>	
      </div>
    </div>
