...
$ksql = "SELECT * FROM {$DB}.output 
         WHERE outdate BETWEEN DATE('{$fromdate}') AND DATE('{$Transtodate}') 
         ORDER BY outdate";
?>
...
<body onload="pagePrintPreview();">
    <div id="print">
        <div class="img">
            <div class="menu">
                <div class="print1_new"><?= htmlspecialchars($Transtodate, ENT_QUOTES, 'UTF-8') ?> 화물 출고 리스트</div>
                <div class="clear"></div>
                ...
                try {
                    ...
                    error_log("화물 출고 리스트 조회 오류: " . $ex->getMessage());
                }
                ?>
            </div>  <!-- end of menu -->
        </div>
