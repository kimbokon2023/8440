			   ...
			   <button type="button" class="btn btn-outline-secondary btn-sm" onclick="size32_4_1680_click();"> 4'x1680 </button> &nbsp;
                ...
                <div class="card-header">
                    <div class="input-group p-2 mb-1">
                        종 류 : &nbsp; <input name="item" id="item" class="form-control" style="width: auto; display: inline-block;" value="<?= htmlspecialchars($item, ENT_QUOTES, 'UTF-8') ?>">&nbsp; &nbsp;
                        규 격 : &nbsp; <input name="spec" id="spec" class="form-control" style="width: auto; display: inline-block;" value="<?= htmlspecialchars($spec, ENT_QUOTES, 'UTF-8') ?>">
                    </div>

                    <div class="input-group p-2 mb-1">
                        주문톤수(ton) : &nbsp; <input name="expected" id="expected" class="form-control" style="width: auto; display: inline-block;" value="<?= htmlspecialchars($expected, ENT_QUOTES, 'UTF-8') ?>">&nbsp; &nbsp;
                    </div>
                    
                    <div class="input-group p-2 mb-1">
                        계산된 매수 : &nbsp; <input name="steelnum" id="steelnum" class="form-control" style="width: auto; display: inline-block;" value="<?= htmlspecialchars($steelnum, ENT_QUOTES, 'UTF-8') ?>">&nbsp; &nbsp;
                    </div>
