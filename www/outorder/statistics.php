...
<div id=list_board >    
	 <div id="title" style="width:300px" ><h2> 시공소장별 시공점유율 차트 </h2> </div>	 
      <div class="clear"></div>	 
  ...
  print " <h3><span style='color:red' > " . $worker_arr[0] . " </span> " . number_format($work_sum[0]) . "(SET), &nbsp;   ";
  ...
  print " <span style='color:brown'> " . $worker_arr[9] . " </span> " . number_format($work_sum[9]) . "(SET) </h3> <br><br>" ; 
...
$('input[name="chart_sel"]').change(function() {
	...
	var myChart = new Chart(ctx, {
		type: chart_type,
		data: {
			labels: [worker_arr[0], worker_arr[1], worker_arr[2],worker_arr[3], worker_arr[4], worker_arr[5],worker_arr[6], worker_arr[7], worker_arr[8],worker_arr[9] ],
			datasets: [{
				label: '#소장별 시공수량 합계 ',
				data: [work_sum[0], work_sum[1], work_sum[2],work_sum[3], work_sum[4], work_sum[5],work_sum[6], work_sum[7], work_sum[8],work_sum[9] ],
				backgroundColor: [
					'rgba(255, 99, 132, 0.2)',
					'rgba(54, 162, 235, 0.2)',
					'rgba(255, 206, 86, 0.2)',
