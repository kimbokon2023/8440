...
try{
				 $pdo->beginTransaction();
						 $sql = "insert into mirae8440.outorder(orderday, firstord, secondord, workplacename, deadline, type, inseung, su, lc_su, etc_su, "; //10
						 $sql .= " car_insize, memo, delivery, startday, workday, demand) "; //6  총16개
