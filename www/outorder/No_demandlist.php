...
<script src="https://uicdn.toast.com/tui-grid/latest/tui-grid.js"></script>	
 ...
 <title> 덴크리/외부발주 미청구리스트 DB </title> 
 </head>
...
$sql ="select * from mirae8440.outorder where ((workday!='') OR (workday!='0000-00-00')) and ((demand IS NULL) or (demand='0000-00-00')) "  . $attached . $a;	   
