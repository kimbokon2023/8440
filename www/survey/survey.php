...
<script>
 function update()
 {
     ...
     window.open("update.php?composer="+vote,"","left=200, top=200, width=250, height=250, status=no,scrollbars=no");
     window.close();
} 

function result()
{
    window.open("result.php","left=200, top=200, width=250, height=250, status=no,scrollbars=no");
    window.close();
}
</script>
</head>
...
<table border="0" cellspacing="0" cellpdding="0"  width="230" align="center">
...
<tr height="5" <td></td></tr>
<tr><td><input type="radio" name="composer" value="ans3"> 3. 끌레앙</td></tr>
<tr height="5" <td></td></tr>
<tr><td><input type="radio" name="composer" value="ans4"> 4. 소르</td></tr>
<tr height="5" <td></td></tr>
<tr height="7" <td></td></tr>
<tr>
<td aligh="middle"><img src="../img/b_vote.gif" border="0" style="cursor:hand" onclick="update()">
