            ...
            <div class="container-fluid">
                <div class="card mt-2">
                    <div class="card-body">
                        ...
                        <div class="d-flex mb-3 mt-2 justify-content-center align-items-center">
                            <div class="alert alert-primary w-50 fs-6" role="alert">
                                <strong> 미래기업 개발프로젝트 연구노트는 '엘리베이터 레이아웃 자동설계' 프로젝트입니다. </strong><br>
                                <strong> 1. 주요 연구개발 진행과정 및 내용</strong>, <strong> 2. 주요 개발진행 이슈와 다음 과정</strong>을 내용으로 기록합니다.
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover" id="myTable">
                                <thead class="table-primary">
                                    <tr>
                                        <th class="text-center w-3" scope="col" style="width:5%;">번호</th>
                                        <th class="text-center w-4" scope="col" style="width:120px;">작성일</th>
                                        <th class="text-center w-3" scope="col"> 작성자 </th>
                                        <th class="text-center w-40" scope="col"> 제목 </th>
                                        <th class="text-center w-15" scope="col"> 검토 </th>
                                        <th class="text-center w-10" scope="col"> 결재라인 </th>
                                        <th class="text-center w-25" scope="col"> 결재내역 </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    ...
                                    error_log("개발프로젝트 연구노트 목록 조회 오류: " . $ex->getMessage());
                                }
                                ?>
                                </tbody>
                            </table>
