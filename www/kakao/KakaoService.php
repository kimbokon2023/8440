...
class KakaoService 
{
    ...
    {   //★ 수정 할 것
        $this->JAVASCRIPT_KEY = "2ddb841648d38606331320046099cf67"; // https://developers.kakao.com > 내 애플리케이션 > 앱 설정 > 요약 정보
        $this->REST_API_KEY   = "a05cf8e20a592a3c7d518203a097f08e"; // https://developers.kakao.com > 내 애플리케이션 > 앱 설정 > 요약 정보
        $this->ADMIN_KEY      = "43f1d485c922c9cf3f7edd6737aaf5a5"; // https://developers.kakao.com > 내 애플리케이션 > 앱 설정 > 요약 정보
        $this->CLIENT_SECRET  = "lPE16DCvWsduAWTue9b51vocFCxxA9Y8"; // https://developers.kakao.com > 내 애플리케이션 > 제품 설정 > 카카오 로그인 > 보안
