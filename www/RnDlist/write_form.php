            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="d-flex mt-2 justify-content-center align-items-center">
                        ...
                        <input id="division" name="division" type="text" class="form-control me-2" style="width:300px;" autocomplete="off" value="<?= htmlspecialchars($division, ENT_QUOTES, 'UTF-8') ?>">&nbsp;
                        <span class="form-control me-2" style="width: 50px;border:0px;">제목</span>
                        <input id="subject" name="subject" type="text" required class="form-control" style="width:600px;" autocomplete="off" value="<?= htmlspecialchars($item_subject, ENT_QUOTES, 'UTF-8') ?>">&nbsp;
                    </div>
                </div>
            </div>
        </div>
