            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div>
                    ...
                    <button type="button" class="btn btn-primary" onclick="location.href='mc_write.php'">
                        <i class="bi bi-plus-lg"></i> 신규 항목 등록
                    </button>
                </div>
            </div>
            
            <div class="alert alert-info py-2">
                <i class="bi bi-info-circle"></i> 총 <strong><?= $total_row ?></strong>개의 항목이 등록되어 있습니다.
            </div>
                ...
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            echo "<tr><td colspan='9' class='text-center py-4'>등록된 항목이 없습니다.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
...
function deleteitem(num) {
    if (confirm("정말 이 정비 항목 정보를 삭제하시겠습니까?")) {
