...
try {
    ...
    $customerSql = "SELECT * FROM `{$dbName}`.`customer` WHERE num = :num AND is_deleted = 'N'";
    ...
    $contactSql = "SELECT * FROM `{$dbName}`.`customer_contact` WHERE customer_id = :num AND is_deleted = 'N' ORDER BY num ASC";
