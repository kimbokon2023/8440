...
<body<?php if ($iframe_mode) echo ' style="background:#f5f7fb; overflow-y: auto; height: 100vh; margin: 0; padding: 0;"'; ?>>
    ...
    $sql = "SELECT * FROM estimate_customer WHERE num = ? AND is_deleted = 'N'";
    ...
    try {
        ...
        // 담당자 정보 조회
        $contactSQL = "SELECT * FROM estimate_customer_contact WHERE customer_id = ? AND is_deleted = 'N' ORDER BY num";
