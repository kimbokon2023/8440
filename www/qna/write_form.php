                    ...
                    <div class="row">
                        ...
                        <div class="col-5-sm">
                            <div class="d-flex mt-2 justify-content-center align-items-center">
                                제목 &nbsp;
                                <input id="subject" name="subject" type="text" required class="form-control" style="width:500px;" value="<?= htmlspecialchars($item_subject, ENT_QUOTES, 'UTF-8') ?>">&nbsp;
                            </div>
                        </div>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $(window).on('resize', function() {
        ...
        if (currentIsMobile !== isMobile) {
            ...
            var newHeight = isMobile ? 300 : 500;
            ...
            data.forEach(function (fileData, index) {
				...
				$("#displayFile").append(
					"<div class='row mt-1 mb-2'>" +
						"<div class='d-flex align-items-center justify-content-center' style='" + fileStyle + "'>" +
							"<span id='file" + index + "'>" +
...
function displayFileLoad() {
    ...
    if (Array.isArray(data) && data.length > 0) {
        data.forEach(function(fileData, i) {
            ...
            $("#displayFile").append(
                "<div class='row mb-3'>" +
                    "<div class='d-flex mb-3 align-items-center justify-content-center' style='" + fileStyle + "'>" +
                        "<span id='file" + i + "'>" +
                            "<a href='#' onclick=\"popupCenter('" + link + "', 'filePopup', 800, 600); return false;\" style='word-wrap:break-word; overflow-wrap:break-word; max-width:100%;'>" + realName + "</a>" +
                        "</span> &nbsp;&nbsp;" +
