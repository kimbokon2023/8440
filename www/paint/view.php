...
<script src="<?= $base_url ?>/order/order.js"></script>
...
<div class="row">
    <div class="col">
        <h1 class="display-5 font-center text-center"> &nbsp; &nbsp; 발주서 조회 </h1>
    </div>
</div>
<div class="row">
    <h1 class="display-5">
...
<div class="row">
    <h1 class="display-5">
        &nbsp; &nbsp; 발 주 일 : <input disabled type="date" id="orderdate" name="orderdate" value="<?= $orderdate ?>" size="14" placeholder="발주일">
    </h1>
</div>
